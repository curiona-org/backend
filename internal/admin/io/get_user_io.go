...
type GetUserOutput struct {
	...
	Roadmaps    ListUserRoadmapOutput `json:"roadmaps"`
}

type ListUserRoadmapOutput = filter.FilteredList[ListUserRoadmapItem]

type ListUserRoadmapItem struct {
	ID                   int                                   `json:"id"`
	...
	PersonalizationOpts  ListUserRoadmapPersonalizationOptions `json:"personalization_options"`
}

type ListUserRoadmapPersonalizationOptions struct {
