...
type GetUserOutput struct {
	...
	Roadmaps    []GetUserOutputRoadmap `json:"roadmaps"`
}

type GetUserOutputRoadmap struct {
	ID                   int                                        `json:"id"`
	...
	PersonalizationOpts  GetUserOutputRoadmapPersonalizationOptions `json:"personalization_options"`
}

type GetUserOutputRoadmapPersonalizationOptions struct {
